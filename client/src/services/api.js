...
export const settingsAPI = {
  ...
  restoreBackup: (backupData) => api.post('/settings/backup/restore', { backup_data: backupData }),
  restoreZipBackup: (formData) => api.post('/settings/backup/restore-zip', formData, {
    headers: {
